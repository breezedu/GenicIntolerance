...
library(snowfall)
sfSetMaxCPUs(number=144)
sfInit(parallel=TRUE, cpus=128, type="SOCK", socketHosts=rep("localhost",128))
...
effect<-answer1$a
write.table(effect, "1118_5Kgene_effectstan.txt", sep="\t")

#check convergence 
pdf("1118_5Kgene_traceplot.pdf")
