...
public class D0322_saveGeneNames_in_ALSdata {
	...
	public static void main(String[] args) throws IOException{
		...
		//this part will leave to D0322_moreInfoAboutGenes.java part;		
	...
	/******************
	 * pass the file reader and the geneNames ArrayList to this method;
	 * check the headline of each file, attract gene names, and compare these names and sequence to the name array we already have;
